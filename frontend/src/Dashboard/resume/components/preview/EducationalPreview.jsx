    ...
    <div className='my-6'>
        ...
        {resumeInfo?.education.map((education, index) => (
            <div key={index} className='my-5'>
                ...
                <h2 className='text-xs flex justify-between'>{education?.degree} in {education?.major} <span>{education?.startDate} - {education?.currentlyStudying?'Present':education?.endDate}</span></h2>
